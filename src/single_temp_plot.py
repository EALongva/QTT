...
### SINGLE TEMPERATURE
location    = "../dat/RUD/"
loadname    = location + "sim_S_4000_N_3000_NTemps_1"

QT_load     = np.load(loadname + ".npy")

# single temp so remove the temperature axis from QT array

QT = QT_load[0]

print(QT_load.shape, QT.shape)
...
result = qp.mesolve(H, qp.Qobj(psi0), times, c_ops, [])
...
figname = "../fig/RUD/TEST_singletemp.png"
...
figname = "../fig/RUD/singletemp_" + "traj_" + str(info[0]) + ".png"
fig.savefig(figname, dpi=400)
